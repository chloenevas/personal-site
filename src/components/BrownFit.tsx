  ...
  return (
    <div className="slide-content">
      <img className="project-photo" src={generate} alt="Photo of BrownFit" />
          <div className="project-description">This is where the user can generate a custom workout.
              They can enter their workout duration, desire muscle groups, and a workout goal. This will then connect to the backend which
          ... </div>
    </div>
  );
}
  ...
  return (
    <div className="slide-content">
      <img className="project-photo" src={progress} alt="Photo of BrownFit" />
          <div className="project-description">If the user is logged in, then they will gain access to their
              progress tab. Here they will be able to see what machines they have generated. They also
          have the opportunity to add machines in themselves.</div>
    </div>
  );
}
  ...
  return (
    <div className="slide-content">
      <img className="project-photo" src={additional} alt="Photo of BrownFit" />
          <div className="project-description">This is a page with additional info, such as resources
          that the user can look into as well as a gym playlist to use while working out</div>
    </div>
  );
}
